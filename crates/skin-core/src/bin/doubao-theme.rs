...
用法：\n\
  ...
  doubao-theme create <theme-dir> --name <名称> --targets <doubao,doubao-work,workbuddy> [--description <描述>] [--accent <#RRGGBB>] [--appearance light|dark|both] [--author <作者>]\n\
  doubao-theme check <theme-dir>\n\
  doubao-theme preview <theme-dir>\n\
  doubao-theme migrate-v3 <theme-dir> [--write]\n\
  doubao-theme pack <theme-dir> [output.doubao-skin.zip]\n\
  doubao-theme install <package>\n\
  doubao-theme apply <theme> [--target doubao|doubao-work|workbuddy] [--watch]\n\
  doubao-theme restore [--target doubao|doubao-work|workbuddy]\n\
