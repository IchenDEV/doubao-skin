//! Minimal Chromium data-pack (.pak v5) reader and writer.
//!
...
mod tests {
    ...
    fn real_resources_pak_roundtrip() {
        ...
        assert_eq!(
            build(&blobs, &pak.aliases, 1),
            original,
            "pak rebuild not lossless"
        );
