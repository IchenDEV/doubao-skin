  ...
  return (
    <main className="reading-page">
      ...
      <header className="reading-head">
        ...
        <h1>使用与下载</h1>
        <p>下载桌面应用，选择适用主题，再应用到 macOS 版「豆包」「豆包工作」或 WorkBuddy。</p>
      </header>
      ...
      <section className="doc-section">
        ...
        <ol className="numbered-list">
          ...
          <li>双击打开“豆皮”；如果系统提示无法打开，点击“完成”关闭弹窗。</li>
          <li>打开「系统设置 → 隐私与安全性」，向下滚动到“安全性”，点击“仍要打开”。</li>
          <li>输入管理员密码确认即可；之后可以像普通应用一样直接打开，不需要关闭系统安全功能。</li>
        </ol>
      </section>
