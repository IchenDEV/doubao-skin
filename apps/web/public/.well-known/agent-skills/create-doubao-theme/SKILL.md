...
5. Run:
   ...
   `doubao-skin create <theme-dir> --name <name> --description <description> --accent <#RRGGBB> --appearance <light|dark|both> --targets <comma-separated-targets> --author <author> --json`
