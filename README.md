...
![豆包主题桌面应用](docs/images/app.png)

![豆包主题在线主题库](docs/images/gallery.png)
...
首次运行时，如 macOS 提示来源未知，请右键应用并选择“打开”。
...
推荐使用 `doubao-theme create` 或 `$create-doubao-theme` 创建符合 `schemaVersion: 2` 的主题。规范见 [主题与界面标准](design/theme-standard/README.md)，字段定义见 [theme-v2.schema.json](design/theme-standard/theme-v2.schema.json)。
